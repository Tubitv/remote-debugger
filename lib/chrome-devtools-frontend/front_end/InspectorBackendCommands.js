...
Protocol.inspectorBackend.registerEvent("Redux.reduxRelay", ['action', 'instanceId', 'isExcess', 'name', 'nextActionId', 'payload', 'type']);
Protocol.inspectorBackend.registerCommand("Redux.reduxRelay", [], [], false);
